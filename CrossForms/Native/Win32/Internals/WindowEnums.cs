...
public enum WindowStyle: uint {
	...
	/// <summary>
	///     The window is a child window. A window with this style cannot have a menu bar. This style cannot be used with
	///     the Popup style.
	/// </summary>
	Child = 0x40000000,

	/// <summary>
	///     Excludes the area occupied by child windows when drawing occurs within the parent window. This style is used
	...
	///     updated.
	///     If ClipSiblings is not specified and child windows overlap, it is possible, when drawing within the client area of
	...
	///     The first control in each group usually has the TabStop style so that the user can move from group to group. The
	///     user can subsequently change the keyboard focus from one control in the group to the next control in the group by
	...
	/// <summary>
	///     The window has a maximize button. Cannot be combined with the WS_EX_CONTEXTHELP style. The WS_SYSMENU style
	...
	/// <summary>
	///     The window has a minimize button. Cannot be combined with the WS_EX_CONTEXTHELP style. The WS_SYSMENU style
	///     must also be specified.
	/// </summary>
	MinimizeBox = 0x20000,
	...
	/// <summary>
	///     The window is a pop-up window. The Caption and WS_POPUPWINDOW styles must be combined to make the window menu
	///     visible.
	/// </summary>
...
public enum WindowStyleEx: uint {
	...
	///     This cannot be used if the window has a class style of either CS_OWNDC or CS_CLASSDC. This style is not supported
	///     in Windows 2000.
	/// </summary>
	/// <remarks>
	///     With Composited set, all descendants of a window get bottom-to-top painting order using double-buffering.
	///     Bottom-to-top painting order allows a descendent window to have translucency (alpha) and transparency (color-key)
	///     effects,
	...
	///     the cursor changes to a question mark with a pointer. If the user then clicks a child window, the child receives a
	///     WM_HELP message.
	...
	///     The shell language must support reading-order alignment for this to take effect.
	///     Using the Rigth style has the same effect as using the SS_RIGHT (static), ES_RIGHT (edit), and
	///     BS_RIGHT/BS_RIGHTBUTTON (button) control styles.
	/// </summary>
	Rigth = 0x00001000,

	/// <summary>
	///     Specifies a window with the vertical scroll bar (if present) to the right of the client area. This is the
	///     default.
	/// </summary>
	...
	/// <summary>
	///     Specifies a window that should be placed above all non-topmost windows and should stay above them, even when the
	...
	/// <summary>
	///     Specifies a window that should not be painted until siblings beneath the window (that were created by the same
	///     thread) have been painted.
...
public enum ShowWindowCommand {
	...
	/// <summary>
	///     Displays a window in its most recent size and position. This value is similar to ShowNormal, except that the
	...
	/// <summary>
	///     Displays the window as a minimized window. This value is similar to ShowMinimized, except the window is not
	///     activated.
	/// </summary>
